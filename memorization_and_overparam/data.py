...
from add_noise import noisify_with_P, multiclass_noisify
...
def read_data(noise_type, noise_rate, dataset, data_aug=False, mode="risk_min"):
   ...
   X_train, X_val, y_train, y_val = model_selection.train_test_split(X_temp, y_temp_noisy, test_size=0.2, random_state=42)
